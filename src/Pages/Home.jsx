...
const WORDS = ["Software Engineering Student", "MERN Stack Developer"];
const TECH_STACK = ["MERN Stack", "Spring Boot", "Java", "Python", "C++", "Figma"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/your-github" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/muhammad-shahmeer-597882318" },
  { icon: Mail, link: "mailto:shahmeerkhokhar365@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Motivated Software Engineering student with hands-on experience in MERN stack development, software system design, and user-centered UI/UX projects. Known for creativity, strong problem-solving skills, and a collaborative mindset.
                </p>
